...
declare module "packages/kdocs/dotview_h5/index" {
    ...
    export type MoreMenu = {
         ...
         * 菜单key
         */
        key: "download" | "share" | "saveas" | string;
        /**
         * 菜单文案
         */
        text: "下载" | "分享" | "另存为" | string;
        [k: string]: any;
    };
    /**
     * 文件信息
    ...
    export interface IConfig {
        Header?: {
            ...
            visible?: boolean;
            /**
             * 顶部文件操作目录(true:显示 false:隐藏) 1.1.3
             */
            moreMenu?: {
                visible?: boolean;
            };
    ...
    export interface IKdocsPcSDK extends ModuleBase<{
        ...
        /**
         * 头部右侧插槽，返回一个Vue实例 file文件信息 1.1.3
         * @param action
         * @param callback
         * 自定义组件参数： file：FileInfo（文件信息）
         */
    ...
    /**
     * IDotviewH5Attach为插件方法的第二个参数对象
     * @interfaceContent
     */
    export interface IDotviewH5Attach extends InitOption<ISdkLanguageVue> {
        /**
         * 拦截器对象
         * @notExported
         */
     ...
     * @notExported
     */
    export namespace ENCS_DOTVIEW_H5 {
        type SDK = IKdocsPcSDK;
        type Attach = IDotviewH5Attach;
    }
}
