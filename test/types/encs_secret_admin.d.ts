...
declare module "packages/encs/secret_admin/index" {
     ...
     * @source
     */
    export interface UserPanelMenu {
        key?: string;
        /**
         * 菜单文案
         */
     ...
     */
    export interface ISecretAdminPcSDK {
        set(config: IConfig): void;
        /**
         * 用户头像下拉菜单过滤
         * @param action Header.userPanel.filter
         * @param callback
         */
        on(action: "Header.userPanel.filter", callback: ISame<UserPanelMenu[]>): any;
        /**
         * 用户头像下拉菜单新增项
         * @param action Header.userPanel.expand
         * @param callback
         */
        on(action: "Header.userPanel.expand", callback: () => ReactElement): any;
        /**
         * 侧边栏菜单屏蔽、文案修改、图标替换、新增菜单项
         * @param action Aside.menu.filter
         * @param callback
         */
        on(action: "Aside.menu.filter", callback: ISame<SubMenu[]>): any;
        /**
         * 侧边栏菜单项新增插槽
         * @param action Aside.menu.expand
         * @param callback
         */
        on(action: "Aside.menu.expand", callback: (menus: SubMenu[]) => ReactElement): any;
        /**
         * 请求拦截器
