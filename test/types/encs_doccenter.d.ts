...
declare module "packages/encs/doccenter/index" {
    ...
    export type HeaderInfo = {
         ...
         * 是否显示下载按钮
         */
        showDownload: string | undefined;
        /**
         * 是否显示打印按钮
         */
        showPrint: string | undefined;
        /**
         * 下载方法
         */
        goDownload: () => void;
     ...
     * Weboffice实例
     */
    export type WebofficeInstance = {
        Application: Object;
        Enum: Object;
        Events: Object;
        WordApplication: Function;
        WpsApplication: Function;
        destroy: Function;
        executeCommandBar: Function;
        off: Function;
        on: Function;
        ready: Function;
        save: Function;
        setCommandBars: Function;
        setCooperUserColor: Function;
        setToken: Function;
    ...
    export interface IConfig {
        ...
        weboffice: {
            /**
             * 配置项 1.0.7 Weboffice配置项 详见https://wwo.wps.cn/docs-js-sdk/#/
             */
            config: object;
        };
    }
     ...
     * @declaration
     */
    export interface IDoccenterPlugSdk extends ModuleBase {
         ...
         * @param callback
         */
        on(action: "fetchRequest", callback: (data: {
            url: string;
            config: RequestInit;
        }) => RequestInit): any;
        /**
         ...
         * @param callback
         */
        on(action: "fetchResponse", callback: (data: {
            url: string;
            config: RequestInit;
            data: any;
        }) => any): any;
         ...
         * @param callback
         */
        on(action: "Document.fileInfo.filter", callback: (fileInfo: FileInfo) => FileInfo): any;
        /**
         * 头部右上角增加插槽 1.0.7
         * @param action
         * @param callback
         */
        on(action: "Header.rightContainer.expand", callback: (data: HeaderInfo) => ReactElement): any;
        /**
         * 下载按钮拦截 1.0.7
         * @param action
         * @param callback
         */
        on(action: "Header.downloadButton.intercept", callback: (data: {
            fileId: string;
            webofficeInstance: WebofficeInstance;
        }) => Promise<boolean>): any;
        /**
         * 打印按钮拦截 1.0.7
         * @param action
         * @param callback
         */
        on(action: "Header.printButton.intercept", callback: (data: {
            fileId: string;
            webofficeInstance: WebofficeInstance;
        }) => Promise<boolean>): any;
        /**
         * 页面初始化获取Weboffice实例 1.0.7
         * @param action
         * @param callback
         */
        on(action: "Header.getWebofficeInstance.emit", callback: (webofficeInstance: WebofficeInstance) => void): any;
        /**
         * @notExported
         * 插入元素
         * @param child
     ...
     * @interfaceContent
     */
    export interface IDoccenterAttach extends InitOption<ISdkLanguageReact> {
        interceptors: {
     ...
     * @notExported
     */
    export namespace ENCS_DOCCENTER {
        type SDK = IDoccenterPlugSdk;
        type Attach = IDoccenterAttach;
    }
    /**
     * @notExported
     */
    export class DoccenterPlugSdk extends SdkBase implements IDoccenterPlugSdk {
        insertDom(child: Node): () => void;
        on(name: string, callback: (data?: any) => any): void;
    }
}
