...
declare module "packages/kdocs/yun/index" {
    import SdkBase from "libs/SdkBase";
    ...
    export interface IKdocsPcSDK extends ModuleBase<{}> {
         ...
         * @param domInstance
         */
        addRootDom(domInstance: any): any;
        /**
         * 侧边栏菜单拦截
         * @since 1.0.7
         * @param event
         * @param callback
         */
        on(event: "Aside.menus.filter", callback: ISame<IRowItem[]>): void;
        /**
         * 文件列表铅笔下拉框拦截
         * @since 1.0.7
         * @param event
         * @param callback
         */
        on(event: "Document.editMenu.filter", callback: ISame<IDropListItem[]>): void;
        /**
         * 分享链接点击复制拦截
         * @since 1.0.7
         * @param event
         * @param callback
         */
        on(event: "Share.Link.filter", callback: ISame<string>): void;
    }
    /**
     * @interfaceContent
     */
    export interface IKdocsPcAttach extends InitOption<ISdkLanguageReact> {
        /**
         * 拦截器对象
         */
        interceptors: {
    ...
    export namespace KDOCS_PCWEB {
        ...
        type Attach = IKdocsPcAttach;
    }
    /**
     * @notExported
     */
    export class KdocsPcSDK extends SdkBase implements IKdocsPcSDK {
        addRootDom(domInstance: any): void;
    }
}
