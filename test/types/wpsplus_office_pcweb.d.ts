...
declare module "packages/wpsplus/office_pcweb/index" {
     ...
     *
     */
    export type emptyMenu = "paste" | "refresh" | "createFolder" | "uploadFolder" | "uploadFile" | "createCompunknownTemplate";
    /**
     * 空白处右键菜单项配置
     *
     */
    export type emptyMenuChildren = {
        cmd: "filter" | "createFile";
        children: ("mtimeDesc" | "mtimeAsc" | "fnameAsc" | "fnameDesc" | "fsizeDesc" | "fsizeAsc" | "createDoc" | "createXls" | "createPpt" | "createPom" | "createPof")[];
    };
    /**
     * @source
     * 文件类型
    ...
    export type ISame<T> = (p: T) => T;
    /**
     * @declaration
     * @ModuleBase [kso,uikit]
     */
    export interface IOfficeWebSDK extends ModuleBase<{
        kso: KsoModule;
        uikit: UikitModule;
    }> {
        set(data: IConfig): void;
        /**
         * 文件列表新建按钮下拉菜单屏蔽、修改文案 1.1.3
         * @param action
         * @param callback
         */
        on(action: "DocslistTopMenu.newIcon.filter", callback: ISame<IMenuList>): void;
        /**
         * @notExported
         * 文件列表上传按钮下拉菜单
         * @param action
         * @param callback
         */
        on(action: "DocslistTopMenu.uploadIcon.filter", callback: ISame<any>): void;
        /**
         * @notExported
         * 文件列表项图标定制
         * @param action
         * @param callback
         */
        on(action: "Document.fileIcon.render", callback: () => BASE.TYPE.VUE): void;
        /**
         * @notExported
         * 文件列表项点击触发
         * @param action
         * @param callback
         */
        on(action: "Document.openFile.intercept", callback: () => boolean): void;
        /**
         * @notExported
         * 文件列表行内注入
         * @param action
         * @param callback
         */
        on(action: "Document.list.expand", callback: () => BASE.TYPE.VUE): void;
        /**
         * @notExported
         * 文件列表菜单项定制
         * @param action
         * @param callback
         */
        on(action: "Document.moreMenu.filter", callback: ISame<any>): void;
        /**
         * 文件列表菜单项拓展 1.1.6
         * @param action
         * @param callback props 传参：selected: SelectedFile 选中的文件列表, tid: string 团队id, fid: string 文件id
         */
        on(action: "Document.moreMenu.expand", callback: (selected: SelectedFile) => BASE.TYPE.VUE): void;
        /**
         * @notExported
         * 空白处右键菜单项定制
         * @param action
         * @param callback
         */
        on(action: "Document.emptyMenu.filter", callback: (params: (emptyMenu | emptyMenuChildren)[][]) => (emptyMenu | emptyMenuChildren)[][]): void;
        /**
         * @notExported
         * 空白处右键菜单项拓展
         * @param action
         * @param callback
         */
        on(action: "Document.emptyMenu.expand", callback: () => BASE.TYPE.VUE): void;
        /**
         * @notExported
         * 文件列表操作栏拓展
         * @param action
         * @param callback
         */
        on(action: "DocslistTopMenu.rightOperation.expand", callback: () => BASE.TYPE.VUE): void;
        /**
         * @notExported
         * 团队列表菜单项定制
         * @param action
         * @param callback
         */
        on(action: "AsideTeam.moreMenu.filter", callback: ISame<any>): void;
        /**
         * @notExported
         * 团队列表菜单项拓展
         * @param action
         * @param callback
         */
        on(action: "AsideTeam.moreMenu.expand", callback: () => BASE.TYPE.VUE): void;
        /**
         * @notExported
         * 团队列表替换
         * @param action
         * @param callback
         */
        on(action: "AsideTeam.root.render", callback: () => BASE.TYPE.VUE): void;
        /**
         * 全局文案替换 1.1.3
         * @param action
         * @param callback
